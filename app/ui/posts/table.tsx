                ...
                <Link href={`/dashboard/posts/${post.id}`} key={post.id}>
                  <div className='grid grid-cols-6 gap-2 md:flex w-full md:flex-col md:items-center md:justify-between pt-4'>
                    <div className='col-span-2'>
                      <h3 className='text-gray-400 font-bold m-0'>When:</h3>
                    ...
                    <div className='col-span-2'>
                      <h3 className='text-gray-400 font-bold m-0'>How Many:</h3>
                      <p className='text-md text-green-500 font-bold m-0'>
                        {post.carpoolers}
                      </p>
                    </div>
                    <div className='col-span-2'>
                      <h3 className='text-gray-400 font-bold m-0'>How Much:</h3>
                      <p className='text-md text-green-500 font-bold m-0'>
                        $20
                      </p>
                    </div>
                    ...
                    <div className='col-span-3'>
                      <h3 className='text-gray-400 font-bold m-0'>From:</h3>
                      <p className='text-md text-green-500 font-bold m-0'>
                        {reverseGeocode(
                          post.start_latitude,
                    ...
                    <div className='col-span-3'>
                      <h3 className='text-gray-400 font-bold m-0'>To:</h3>
                      <p className='text-md text-green-500 font-bold m-0'>
